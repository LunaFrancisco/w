...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:block fixed inset-y-0 left-0 w-64 bg-white shadow-sm rounded-tr-2xl z-30">
        <nav className="h-full pt-4">
...
function AdminSidebar({ pathname }: { pathname: string }) {
  ...
  return (
    <ul role="list" className="space-y-1 pt-8sssssssssssssssssssss">
      {navigation.map((item) => {
...
function DocumentCheckIcon(props: any) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function DocumentChartBarIcon(props: any) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
